...
window.addEventListener("load", () => {
  ...
  document.getElementById("create-room").addEventListener("click", (e) => {
    ...
    var loginForm = document.forms["form-sub"];
    console.log(loginForm);

    var setRoomName = JSON.stringify(roomName);
    var setYourName = JSON.stringify(yourName);
    localStorage.setItem("key", [setRoomName, setYourName]);
